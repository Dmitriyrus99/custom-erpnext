...
def _ensure_folder(drive, name: str, parent_id: Optional[str]) -> Optional[str]:
...
def upload_bytes(path_parts: list[str], filename: str, data: bytes, mime_type: str = "application/pdf") -> Optional[str]:
