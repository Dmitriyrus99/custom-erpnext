...
import frappe
from ferum_custom.patches.utils_migration import _log, _warn, find_or_create_project, migrate_attachments, has_doctypes
...
def execute():
    ...
    _log(f"migrate_service_project_to_project: ok={ok} skipped={skipped} attachments_ok={att_ok} attachments_skipped={att_skip}")
