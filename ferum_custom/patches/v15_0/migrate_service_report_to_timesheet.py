...
from ferum_custom.patches.utils_migration import _log, migrate_attachments, find_or_create_project, has_doctypes
...
def execute():
    ...
    _log(f"migrate_service_report_to_timesheet: ok={ok} skipped={skipped} attachments_ok={att_ok} attachments_skipped={att_skip}")
