...
def execute():
    ...
    if not item_code or not category:
        _log("migrate_service_object_to_asset: missing default_item_code or Asset Category; skipping migration")
        _log("Tip: set Ferum Custom Settings.default_item_code and ensure an 'Asset Category' exists")
        return
