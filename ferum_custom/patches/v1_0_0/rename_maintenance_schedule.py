...
def execute():
	...
	try:
		...
		if ms:
			frappe.rename_doc("DocType", "Maintenance Schedule", "Service Maintenance Schedule", force=True)
	except Exception:
		pass
	try:
		...
		if msi:
			frappe.rename_doc(
				"DocType", "Maintenance Schedule Item", "Service Maintenance Schedule Item", force=True
			)
	except Exception:
		pass
