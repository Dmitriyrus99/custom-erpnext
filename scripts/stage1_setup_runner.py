...
# Add the specific script directory to sys.path
script_dir = os.path.join(bench_path, "apps", "ferum_custom", "scripts")
if script_dir not in sys.path:
    sys.path.insert(0, script_dir)

# Initialize Frappe context
# The site name is hardcoded, assuming erpclone.ferumrus.ru is the target
