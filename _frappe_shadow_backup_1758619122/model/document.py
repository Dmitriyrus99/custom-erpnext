...
class Document(metaclass=DocumentMeta):
	...
	def __init__(
		...
		*,
		...
		self.doctype = doctype or self.doctype
	...
	def _current_value(self, field: str) -> Any:
		...
		if isinstance(value, list):
			return [
				item.__dict__.copy() if isinstance(item, SimpleNamespace) else copy.deepcopy(item)
				for item in value
			]
		return copy.deepcopy(value)
	...
	def db_set(self, field: str, value: Any, commit: bool | None = None) -> None:  # - API compat
