...
def load() -> Settings:
    ...
    return Settings(
        ...
        verify_ssl=((_get_env("VERIFY_SSL", ["FERUM_VERIFY_SSL"], default="true").lower()) in ("1", "true", "yes", "on")),
...
def _get_env(primary: str, fallbacks: list[str] | None = None, default: str | None = None) -> str | None:
